...
# defaults
BASE="$(dirname $0)"
iso="$BASE/OpenCore.debug.iso"
img="$BASE/OpenCore.debug.qcow2"
...
BASE="$(dirname $0)"
cp -a $BASE/EFI_DEBUG $WORK 2>/dev/null
find "$WORK"
...
fish copy-in $WORK/EFI_DEBUG/BOOT /ESP/EFI
fish copy-in $WORK/EFI_DEBUG/OC/OpenCore.efi /ESP/EFI/OC
fish copy-in $WORK/EFI_DEBUG/OC/Drivers /ESP/EFI/OC/
fish copy-in $WORK/EFI_DEBUG/OC/Kexts /ESP/EFI/OC/
fish copy-in $WORK/EFI_DEBUG/OC/ACPI /ESP/EFI/OC/
fish copy-in $BASE/../resources/OcBinaryData/Resources /ESP/EFI/OC/
fish copy-in $WORK/EFI_DEBUG/OC/Tools /ESP/EFI/OC/
